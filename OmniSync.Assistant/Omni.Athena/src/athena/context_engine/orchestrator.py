...
from athena.context_engine.state import StateService, FileContext
from athena.context_engine.engine import ContextEngine
from athena.context_engine.git_history import GitHistoryService
from athena.context_engine.skeleton import SkeletonExtractor
from athena.context_engine.skills import SkillDiscovery
...
class AssistantOrchestrator:
    ...
    def get_context_summary(self) -> str:
        ...
        lines.append("OMNI ASSISTANT CONTEXT:")
        ...
        if files:
            ...
            lines.append("\n[STRUCTURE]\n(No index found. Run 'omni:sync' to generate context.)")
    ...
    def handle_session(self):
        ...
        response = {
            "systemMessage": f"✦ Omni | {self.project_root.name} ✦",
            "hookSpecificOutput": {
