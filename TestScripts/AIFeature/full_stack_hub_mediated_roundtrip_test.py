...
def main():
    ...
    # 2. Cleanup existing AI components (no longer needed for ai_listener.py)
    ...
    print("[4/5] Hub AI Service will now handle discovery automatically.")
    print("  - Waiting 3s for Hub to notice the new session...")
    time.sleep(3)
