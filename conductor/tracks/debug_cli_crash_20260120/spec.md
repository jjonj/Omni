...
```bash
cmd.exe /K "set GEMINI_DEBUG_LOG_FILE=[root]\gemini_cli_debug.log && title OMNI_GEMINI_INTERACTIVE && cd /d "[omni-gemini-cli-dir]" && node bundle/gemini.js --workspace "[workspace]" --yolo"
```
