...
- [x] Task: Scaffold the `omni` extension in `D:\SSDProjects\Tools\gemini-cli\extensions\omni\`.
...
- [~] Task: Add activity logging in the Hub for all extension-triggered actions.
